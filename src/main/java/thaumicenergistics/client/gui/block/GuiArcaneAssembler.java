...
public class GuiArcaneAssembler extends GuiUpgradeable<ContainerArcaneAssembler> {
    ...
    private static final ResourceLocation BACKGROUND_ACTIVE = id("textures/gui/arcane_assembler/active.png");
    private static final ResourceLocation ASPECTS = id("textures/gui/arcane_assembler/aspects.png");
